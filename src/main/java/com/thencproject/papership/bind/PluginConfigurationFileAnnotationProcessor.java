...
/**
 * Annotation Processor for the PluginConfigurationFile
 * annotation so that a paper-plugin.yml is generated automatically
 * created
 */
@SupportedAnnotationTypes("com.thencproject.papership.annotations.PluginConfigurationFile")
@SupportedSourceVersion(SourceVersion.RELEASE_21)
public class PluginConfigurationFileAnnotationProcessor extends AbstractProcessor {

    /**
     * Searches for the Annotations and checks if the annotation
     * is used correctly then generates a paper-plugin.yml
     */
    @Override
    ...
    /**
     * helper method to generate a paper-plugin.yml file and put them also
     * into the output so the normal one is overridden by the annotation
     * defined plugin configuration
     */
    private void generatePaperPluginYml(PluginConfigurationFile config, TypeElement classElement)
        ...
        try (Writer writer = resource.openWriter()) {
            writer.write("# Auto-generated by PaperShip Framework\n");
